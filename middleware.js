    ...
    if (isBot) {
      ...
      try {
        ...
        if (hotel) {
          ...
          const image = hotel.image ? (hotel.image.startsWith('http') ? hotel.image : `https://hotelsnearmeinkera.la${hotel.image.startsWith('/') ? '' : '/'}${hotel.image}`) : 'https://hotelsnearmeinkera.la/sharing-banner.webp';
